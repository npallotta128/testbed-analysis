...
# Load data from CSV file (now using local file)
...
# Iterate over the next 1 timepoint to test clustering
for i in range(1):
    ...
    print(f"Completed iteration {i+1}/10 in {iteration_time:.2f} seconds")
...
print(f"Average time per iteration: {total_duration/10:.2f} seconds")
